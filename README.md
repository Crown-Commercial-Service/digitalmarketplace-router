...
The app-level nginx configurations can be found in the [Docker base repo](https://github.com/Crown-Commercial-Service/digitalmarketplace-docker-base).
...
repo](https://github.com/Crown-Commercial-Service/digitalmarketplace-aws/tree/main/paas). View them with `cf env router`.

The PaaS manifests are generated by the [AWS
Makefile](https://github.com/Crown-Commercial-Service/digitalmarketplace-aws/blob/main/Makefile) using the appropriate set of
encrypted
[`vars`](https://github.com/Crown-Commercial-Service/digitalmarketplace-credentials/tree/master/vars), so ultimately
these variables are coming from the [credentials
repo](https://github.com/Crown-Commercial-Service/digitalmarketplace-credentials).  
...
as the frontend apps are all on the same host - [more info about this is available on the DM manual](https://crown-commercial-service.github.io/digitalmarketplace-manual/developing-the-digital-marketplace/application-architecture.html?#overall-architecture)).
